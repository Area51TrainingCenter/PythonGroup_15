...
print(re.match(r'Eat\dCake', 'Eat9Cake').group())  # digit
...
# Grouping
print(re.match(r'Number: [abc]', 'Number: b').group())  # matches with a, b or c
print(re.match(r'Number: [0-9]', 'Number: 7').group())  # is equivalent to \d
print(re.match(r'Number: [a-zA-Z]', 'Number: M').group())  # matches with all letters

# Repetitions
print(re.search(r'C.+kies', 'Cooooooooooookies').group())  # 1 or more
